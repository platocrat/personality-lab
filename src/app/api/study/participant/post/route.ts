  ...
  if (req.method === 'POST') {
    ...
    try {
          ...
          try {
            ...
            try {
              ...
              if (response.Items && response.Items.length > 0) {
                ...
                const message = `'participants' property for study ID ${studyId
                  } has been updated in the ${TableName} table`
            ...
            console.log(
              `Error performing Update operation on EXISTING account entry in the '${TableName
      ...
      try {
        ...
        console.log(
          `Error performing Update operation on the NEW account entry '${TableName
          }' to update the 'participant' property: `,
          error
        )
