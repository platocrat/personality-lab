export enum Gender__GACUsGender {
  Male = `Male`,
  Female = `Female`,
  Agender = `Agender`,
...
export enum MaritalStatus__GACUsGender {
  Married = 'Married',
  Widowed = `Widowed`,
  Divorced = `Divorced`,
  Separated = `Separated`,
...
export enum CurrentEmploymentStatus__GACUsGender {
...
export enum HighestLevelOfEducation__GACUsGender {
