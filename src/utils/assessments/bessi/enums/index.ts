...
export enum CurrentMaritalStatus {
  NeverMarried = `Never married`,
  Married = `Married`,
  DivorcedOrSeparated = `Divorced or seprated`,
  Widowed = `Widowed`,
}
...
export enum CurrentEmploymentStatus {
  ...
  WorkPartTime = `Work part-time`,
  WorkFullTime = `Work full-time`,
}

export enum HighestFormalEducation {
  HaveNotCompletedHighSchool = `Have not completed high school`,
