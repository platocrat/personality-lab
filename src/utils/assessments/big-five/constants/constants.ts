...
export const BIG_FIVE_PATH = `big-five`
export const BIG_FIVE_ASSESSMENT_HREF = `/${ BIG_FIVE_PATH }/assessment`


export const BIG_FIVE_FORM_IDS = [
  'consent-info',
...
export const BIG_FIVE_FRAGMENT_ID_PREFACES = (
  fragmentName: string
): string => {
  const MAIN = BIG_FIVE_PATH
...
export const BIG_FIVE_ACTIVITY_BANK_LEGEND = {
...
export const BIG_FIVE_ACTIVITY_BANK = {
  spendTimeWithOthers: [
