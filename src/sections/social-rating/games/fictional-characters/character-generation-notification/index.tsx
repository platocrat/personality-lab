...
export type CharacterGenerationNotificationProps = {
  state: {
    completed: boolean
    totalPrompts: number
...
const CharacterGenerationNotification: FC<CharacterGenerationNotificationProps> = ({ 
  state 
}) => {
  return (
    <>
...
export default CharacterGenerationNotification